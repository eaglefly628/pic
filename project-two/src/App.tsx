...
import { IconSummary, IconPhoto, IconPin, IconAlbum, IconLock, IconUpload, IconGear, IconSearch, IconImage } from "./icons";
...
type Screen = "summary" | "gallery" | "places" | "albums" | "private" | "import" | "settings";
...
const TITLES: Record<Screen, string> = { summary: "总览", gallery: "图库", places: "地点", albums: "相册", private: "私密区", import: "导入", settings: "设置" };
