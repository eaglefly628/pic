// 「开发世界」首次进入时的示例内容（可随时编辑/删除）。
import type { DevWorld } from "../vault/types";
...
export function sampleDevWorld(): DevWorld {
  return {
    tasks: [
