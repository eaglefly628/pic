...
type View = "overview" | "tasks" | "calendar" | "notes" | "snippets" | "links" | "life" | "accounts" | "company" | "sports" | "secrets" | "disk" | "settings";
const TABS: { v: View; l: string }[] = [
  { v: "overview", l: "概览" }, { v: "tasks", l: "任务" }, { v: "calendar", l: "日程" }, { v: "notes", l: "笔记" },
  { v: "snippets", l: "片段" }, { v: "links", l: "书签" }, { v: "life", l: "生活" }, { v: "accounts", l: "账户" }, { v: "company", l: "公司" }, { v: "sports", l: "看球" }, { v: "secrets", l: "密钥" }, { v: "disk", l: "磁盘" }, { v: "settings", l: "设置" },
];
